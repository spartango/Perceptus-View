        ...
        getTileError: function() {
            if (!this._tileError) {
                ...
                this._tileError = function(manager, tile) {
                    tile.element.src = 'data:image/png;base64,';
...
mapbox.layer = function() {
    ...
    this.setProvider(new wax.mm._provider({
        tiles: ['data:image/png;base64,']
    }));
};
